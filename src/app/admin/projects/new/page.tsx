      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
          ...
          <div>
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="px-4 py-3 bg-muted border border-border font-medium text-sm rounded-lg hover:bg-muted/80 transition-colors whitespace-nowrap"
              >
                Auto-generate
              </button>
            </div>
        ...
        <div className="bg-card border border-border rounded-xl p-6 space-y-4">
          ...
          <p className="text-sm text-muted-foreground">
            The first image is set as the hero by default. Click &quot;Set Hero&quot; on any image
            to change it.
          </p>
          <ImageUploader projectId={projectId} onChange={setImages} />
        </div>
        ...
        <div className="bg-card border border-border rounded-xl p-6 space-y-4">
          ...
          <FileUploader projectId={projectId} onChange={setModelUrl} />
        </div>
        ...
        <div className="bg-card border border-border rounded-xl p-6 space-y-4">
          ...
          <label className="flex items-center gap-3 cursor-pointer group">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Show on the homepage featured projects section
              </p>
            </div>
          </label>
        </div>

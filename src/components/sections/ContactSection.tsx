...
export function ContactSection() {
  ...
  return (
    <section id="contact" className="w-full py-24 md:py-32 px-6 lg:px-8 section-alt">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="max-w-2xl mx-auto">
          <h3 className="text-xl font-medium text-foreground mb-2 text-center">Common Questions</h3>

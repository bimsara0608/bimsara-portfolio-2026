...
export function AboutSection({ profile }: AboutSectionProps) {
  ...
  return (
    <section id="about" className="w-full py-24 md:py-32 px-6 lg:px-8 section-alt">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
          ...
          <div className="lg:col-span-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="card p-6">
                <GraduationCap size={20} className="text-muted-foreground mb-4" strokeWidth={1.5} />
                <h4 className="font-medium text-foreground text-sm mb-1">BSc Engineering (Hons)</h4>
